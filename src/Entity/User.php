...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    private ?ProfilCandidat $ProflCandidatid = null;
    ...
    public function getProflCandidatid(): ?ProfilCandidat
    {
        return $this->ProflCandidatid;
    }

    public function setProflCandidatid(?ProfilCandidat $ProflCandidatid): self
    {
        $this->ProflCandidatid = $ProflCandidatid;
